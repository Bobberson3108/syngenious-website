...
<nav class="z-[8] fixed h-[10vh] top-0 bg-light dark:bg-dark bg-opacity-90 w-full px-6 flex justify-between items-center">
    ...
    <div class="flex justify-center items-center">
        ...
        {:else}
            <SlidingButton hasFill buttonText={"Join Us"} textSize={20} paddingX={16} paddingY={2} marginTop={0}/>
            <SlidingButton buttonText={"Sign In"} textSize={20} paddingX={16} paddingY={2} marginTop={0} marginRight={0}/>
        {/if}
