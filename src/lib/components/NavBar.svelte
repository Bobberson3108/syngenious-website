...
<nav class="z-[8] fixed h-[10vh] top-0 bg-light dark:bg-dark bg-opacity-90 w-full px-6 flex justify-between items-center">
    ...
    <div class="flex justify-center items-center">
        ...
        {:else}
            ...
            <a id="signInNav" class="menuButton h-9 w-auto bg-light dark:bg-dark hover:bg-dark dark:hover:bg-light px-4 font-display font-medium text-dark dark:text-light hover:text-light dark:hover:text-dark ease-out duration-200 uppercase rounded-xl border-2 border-dark dark:border-light ml-4">Sign In</a>
        {/if}
