...
<div class="grid h-[80vh] place-items-center text-dark dark:text-light">
  {#if isLoginForm}
    ...
    <form on:submit={handleLoginSubmit} class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <input class="shadow appearance-none cursor-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username or Email"/>
        </div>
        <div class="mb-6">
